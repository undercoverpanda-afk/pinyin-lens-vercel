            ...
            body: JSON.stringify({
                ...
                messages: [{
                    ...
                    content: [
                        ...
                        {
                            type: 'text',
                            text: 'Provide the pinyin pronunciation for all chinese charecters in this image. Only provide characters and pinyin, no explanations. Detail when translations from new columns begin. Include numbers if there are any. If no Chinese characters are found, please say so.'
                        }
                    ]
                }]
            })
